...
<div class="twelve columns">	
	...
	<h1 font face="COMIC SANS MS">Facebook</h1>
		...
		<?php
				...
				$retrives = $facebook->api('/search?q='.$query.'&type='.$types.'&limit=20');
				...
				foreach($json_o->data as $p)
				{
				 $text = $p->message;
						...
						if($text != null ){ 
						echo "<img src='https://graph.facebook.com/".$id."/picture' width='50' height='50'  /><a href='"."http://www.facebook.com/".$id."'target='new' color='red'>$username</a></br>
				$text</br>";
						}	
