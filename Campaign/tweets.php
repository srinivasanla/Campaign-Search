...
<h1 class="animated BeanFadeDown"><?php echo $title; ?> - Tweets</h1>
...
<div class="twelve columns">	
	...
	<?php
		if (isset($title)) 
		{
			$tweets = $twitter->get('https://api.twitter.com/1.1/search/tweets.json?q='.$title.'&result_type=recent&count=50');
